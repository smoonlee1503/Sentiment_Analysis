...
st.markdown("This application is a streamlit dashboard to anlayze the sentiment of Tweet 🐦")
st.sidebar.markdown("This application is a streamlit dashboard to anlayze the sentiment of Tweet 🐦")
